...
namespace Api.AspNetCore.Services
{
    public class JwtTokenAuthenticationService : IAuthenticateService
    {
            ...
            Func<User, List<Claim>, Task> claimOperation = null)
        {
            ...
            return await GenerateJwtToken(user, "I'm currently deprecated, do not use me!!!", claimOperation);
        }

        public async Task<JwtToken> RefreshTokenAsync(RefreshTokenRequest request)
        {
            return new JwtToken { Key = "I'm currently deprecated, do not use me!!!", 
                RefreshToken = "I'm currently deprecated, do not use me!!!" };
            ...
            //    if (DateTime.Now >= refreshTokenObj.Expires)
            //    {
            ...
            //catch (Exception ex)
            //{
            //    logger.LogError("Refresh token deserialize error: ", ex);
            //    return null;
            //}
            ...
            //return GenerateJwtToken(user.Login, user.Id, roles, refreshToken);
        }
            ...
            Func<User, List<Claim>, Task> claimOperation = null)
        {
            ...
            // TODO: refresh token is deprecated!!!
