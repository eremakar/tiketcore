...
{
    public partial class TicketStatesController
    {
        /// <summary>
        /// Add new ticketState
        /// </summary>
        ...
        public override async Task<object> AddAsync([FromBody] TicketStateDto request)
        {
        ...
        [Produces(MediaTypeNames.Application.Json)]
        [Consumes(MediaTypeNames.Application.Json)]
        public override async Task<object> UpdateAsync([FromBody] TicketStateDto request)
        {
        ...
        /// <response code="400">Validation errors detected, operation denied</response>
        /// <response code="401">Unauthorized request</response>
        [Route("/api/v1/ticketStates/patch")]
        [HttpPatch("{id}")]
        ...
        [Produces(MediaTypeNames.Application.Json)]
        [Consumes(MediaTypeNames.Application.Json)]
        public override async Task<IActionResult> PatchAsync(long id, [FromBody] JsonPatchDocument<TicketStateDto> patch)
        {
