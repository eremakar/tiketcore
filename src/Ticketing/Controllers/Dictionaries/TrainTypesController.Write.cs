...
{
    public partial class TrainTypesController
    {
        /// <summary>
        /// Add new trainType
        /// </summary>
        ...
        public override async Task<object> AddAsync([FromBody] TrainTypeDto request)
        {
        ...
        [Produces(MediaTypeNames.Application.Json)]
        [Consumes(MediaTypeNames.Application.Json)]
        public override async Task<object> UpdateAsync([FromBody] TrainTypeDto request)
        {
        ...
        [Produces(MediaTypeNames.Application.Json)]
        [Consumes(MediaTypeNames.Application.Json)]
        public override async Task<IActionResult> PatchAsync(long id, [FromBody] JsonPatchDocument<TrainTypeDto> patch)
        {
