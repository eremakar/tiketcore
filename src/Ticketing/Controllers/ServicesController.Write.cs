...
namespace Ticketing.Controllers
{
    public partial class ServicesController
    {
        ...
        public override async Task<object> AddAsync([FromBody] ServiceDto request)
        {
        ...
        [Produces(MediaTypeNames.Application.Json)]
        [Consumes(MediaTypeNames.Application.Json)]
        public override async Task<object> UpdateAsync([FromBody] ServiceDto request)
        {
        ...
        [Produces(MediaTypeNames.Application.Json)]
        [Consumes(MediaTypeNames.Application.Json)]
        public override async Task<IActionResult> PatchAsync(long id, [FromBody] JsonPatchDocument<ServiceDto> patch)
        {
