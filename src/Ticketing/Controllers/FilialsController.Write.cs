...
{
    public partial class FilialsController
    {
        /// <summary>
        /// Add new filial
        /// </summary>
        ...
        public override async Task<object> AddAsync([FromBody] FilialDto request)
        {
        ...
        [Produces(MediaTypeNames.Application.Json)]
        [Consumes(MediaTypeNames.Application.Json)]
        public override async Task<object> UpdateAsync([FromBody] FilialDto request)
        {
        ...
        [Produces(MediaTypeNames.Application.Json)]
        [Consumes(MediaTypeNames.Application.Json)]
        public override async Task<IActionResult> PatchAsync(long id, [FromBody] JsonPatchDocument<FilialDto> patch)
        {
