...
{
    public partial class WagonTypesController
    {
        /// <summary>
        /// Add new wagonType
        /// </summary>
        ...
        public override async Task<object> AddAsync([FromBody] WagonTypeDto request)
        {
        ...
        [Produces(MediaTypeNames.Application.Json)]
        [Consumes(MediaTypeNames.Application.Json)]
        public override async Task<object> UpdateAsync([FromBody] WagonTypeDto request)
        {
        ...
        [Produces(MediaTypeNames.Application.Json)]
        [Consumes(MediaTypeNames.Application.Json)]
        public override async Task<IActionResult> PatchAsync(long id, [FromBody] JsonPatchDocument<WagonTypeDto> patch)
        {
