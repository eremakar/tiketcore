...
{
    public partial class WorkflowTaskProgressesController
    {
        /// <summary>
        /// Add new workflowTaskProgress
        /// </summary>
        /// <remarks>
        /// </remarks>
        ...
        public override async Task<object> AddAsync([FromBody] WorkflowTaskProgressDto request)
        {
            return await base.AddAsync(request);
        }

        /// <summary>
        /// Update workflowTaskProgress
        /// </summary>
        /// <remarks>
        /// </remarks>
        ...
        [Produces(MediaTypeNames.Application.Json)]
        [Consumes(MediaTypeNames.Application.Json)]
        public override async Task<object> UpdateAsync([FromBody] WorkflowTaskProgressDto request)
        {
            return await base.UpdateAsync(request);
        }

        /// <summary>
        /// Patch workflowTaskProgress
        /// </summary>
        /// <remarks>
        /// </remarks>
        /// <response code="200">OK</response>
        /// <response code="400">Validation errors detected, operation denied</response>
        /// <response code="401">Unauthorized request</response>
        [Route("/api/v1/workflowTaskProgresses/patch")]
        [HttpPatch("{id}")]
        ...
        [Produces(MediaTypeNames.Application.Json)]
        [Consumes(MediaTypeNames.Application.Json)]
        public override async Task<IActionResult> PatchAsync(long id, [FromBody] JsonPatchDocument<WorkflowTaskProgressDto> patch)
        {
            return await base.PatchAsync(id, patch);
        }

        /// <summary>
        /// Remove workflowTaskProgress
        /// </summary>
        /// <remarks>
        /// </remarks>
        /// <response code="200">OK</response>
