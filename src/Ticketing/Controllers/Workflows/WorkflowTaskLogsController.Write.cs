...
{
    public partial class WorkflowTaskLogsController
    {
        /// <summary>
        /// Add new workflowTaskLog
        /// </summary>
        /// <remarks>
        /// </remarks>
        ...
        public override async Task<object> AddAsync([FromBody] WorkflowTaskLogDto request)
        {
            return await base.AddAsync(request);
        }

        /// <summary>
        /// Update workflowTaskLog
        /// </summary>
        /// <remarks>
        /// </remarks>
        ...
        [Produces(MediaTypeNames.Application.Json)]
        [Consumes(MediaTypeNames.Application.Json)]
        public override async Task<object> UpdateAsync([FromBody] WorkflowTaskLogDto request)
        {
            return await base.UpdateAsync(request);
        }

        /// <summary>
        /// Patch workflowTaskLog
        /// </summary>
        /// <remarks>
        /// </remarks>
        /// <response code="200">OK</response>
        /// <response code="400">Validation errors detected, operation denied</response>
        /// <response code="401">Unauthorized request</response>
        [Route("/api/v1/workflowTaskLogs/patch")]
        [HttpPatch("{id}")]
        ...
        [Produces(MediaTypeNames.Application.Json)]
        [Consumes(MediaTypeNames.Application.Json)]
        public override async Task<IActionResult> PatchAsync(long id, [FromBody] JsonPatchDocument<WorkflowTaskLogDto> patch)
        {
            return await base.PatchAsync(id, patch);
        }

        /// <summary>
        /// Remove workflowTaskLog
        /// </summary>
        /// <remarks>
        /// </remarks>
        /// <response code="200">OK</response>
