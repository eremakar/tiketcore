...
{
    public partial class SeatTariffHistoriesController
    {
        /// <summary>
        /// Add new seatTariffHistory
        /// </summary>
        /// <remarks>
        /// </remarks>
        ...
        public override async Task<object> AddAsync([FromBody] SeatTariffHistoryDto request)
        {
            return await base.AddAsync(request);
        }

        /// <summary>
        /// Update seatTariffHistory
        /// </summary>
        /// <remarks>
        /// </remarks>
        ...
        [Produces(MediaTypeNames.Application.Json)]
        [Consumes(MediaTypeNames.Application.Json)]
        public override async Task<object> UpdateAsync([FromBody] SeatTariffHistoryDto request)
        {
            return await base.UpdateAsync(request);
        }

        /// <summary>
        /// Patch seatTariffHistory
        /// </summary>
        /// <remarks>
        /// </remarks>
        /// <response code="200">OK</response>
        /// <response code="400">Validation errors detected, operation denied</response>
        /// <response code="401">Unauthorized request</response>
        [Route("/api/v1/seatTariffHistories/patch")]
        [HttpPatch("{id}")]
        ...
        [Produces(MediaTypeNames.Application.Json)]
        [Consumes(MediaTypeNames.Application.Json)]
        public override async Task<IActionResult> PatchAsync(long id, [FromBody] JsonPatchDocument<SeatTariffHistoryDto> patch)
        {
            return await base.PatchAsync(id, patch);
        }

        /// <summary>
        /// Remove seatTariffHistory
        /// </summary>
        /// <remarks>
        /// </remarks>
        /// <response code="200">OK</response>
