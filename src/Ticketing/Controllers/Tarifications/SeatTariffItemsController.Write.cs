...
{
    public partial class SeatTariffItemsController
    {
        /// <summary>
        /// Add new seatTariffItem
        /// </summary>
        /// <remarks>
        /// </remarks>
        ...
        public override async Task<object> AddAsync([FromBody] SeatTariffItemDto request)
        {
            return await base.AddAsync(request);
        }

        /// <summary>
        /// Update seatTariffItem
        /// </summary>
        /// <remarks>
        /// </remarks>
        ...
        [Produces(MediaTypeNames.Application.Json)]
        [Consumes(MediaTypeNames.Application.Json)]
        public override async Task<object> UpdateAsync([FromBody] SeatTariffItemDto request)
        {
            return await base.UpdateAsync(request);
        }

        /// <summary>
        /// Patch seatTariffItem
        /// </summary>
        /// <remarks>
        /// </remarks>
        /// <response code="200">OK</response>
        /// <response code="400">Validation errors detected, operation denied</response>
        /// <response code="401">Unauthorized request</response>
        [Route("/api/v1/seatTariffItems/patch")]
        [HttpPatch("{id}")]
        ...
        [Produces(MediaTypeNames.Application.Json)]
        [Consumes(MediaTypeNames.Application.Json)]
        public override async Task<IActionResult> PatchAsync(long id, [FromBody] JsonPatchDocument<SeatTariffItemDto> patch)
        {
            return await base.PatchAsync(id, patch);
        }

        /// <summary>
        /// Remove seatTariffItem
        /// </summary>
        /// <remarks>
        /// </remarks>
        /// <response code="200">OK</response>
