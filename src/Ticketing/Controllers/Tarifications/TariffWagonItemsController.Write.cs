...
{
    public partial class TariffWagonItemsController
    {
        /// <summary>
        /// Add new tariffWagonItem
        /// </summary>
        /// <remarks>
        /// </remarks>
        ...
        public override async Task<object> AddAsync([FromBody] TariffWagonItemDto request)
        {
            return await base.AddAsync(request);
        }

        /// <summary>
        /// Update tariffWagonItem
        /// </summary>
        /// <remarks>
        /// </remarks>
        ...
        [Produces(MediaTypeNames.Application.Json)]
        [Consumes(MediaTypeNames.Application.Json)]
        public override async Task<object> UpdateAsync([FromBody] TariffWagonItemDto request)
        {
            return await base.UpdateAsync(request);
        }

        /// <summary>
        /// Patch tariffWagonItem
        /// </summary>
        /// <remarks>
        /// </remarks>
        /// <response code="200">OK</response>
        /// <response code="400">Validation errors detected, operation denied</response>
        /// <response code="401">Unauthorized request</response>
        [Route("/api/v1/tariffWagonItems/patch")]
        [HttpPatch("{id}")]
        ...
        [Produces(MediaTypeNames.Application.Json)]
        [Consumes(MediaTypeNames.Application.Json)]
        public override async Task<IActionResult> PatchAsync(long id, [FromBody] JsonPatchDocument<TariffWagonItemDto> patch)
        {
            return await base.PatchAsync(id, patch);
        }

        /// <summary>
        /// Remove tariffWagonItem
        /// </summary>
        /// <remarks>
        /// </remarks>
        /// <response code="200">OK</response>
