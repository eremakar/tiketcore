...
{
    public partial class TariffWagonTypeItemsController
    {
        /// <summary>
        /// Add new tariffWagonTypeItem
        /// </summary>
        /// <remarks>
        /// </remarks>
        ...
        public override async Task<object> AddAsync([FromBody] TariffWagonTypeItemDto request)
        {
            return await base.AddAsync(request);
        }

        /// <summary>
        /// Update tariffWagonTypeItem
        /// </summary>
        /// <remarks>
        /// </remarks>
        ...
        [Produces(MediaTypeNames.Application.Json)]
        [Consumes(MediaTypeNames.Application.Json)]
        public override async Task<object> UpdateAsync([FromBody] TariffWagonTypeItemDto request)
        {
            return await base.UpdateAsync(request);
        }

        /// <summary>
        /// Patch tariffWagonTypeItem
        /// </summary>
        /// <remarks>
        /// </remarks>
        /// <response code="200">OK</response>
        /// <response code="400">Validation errors detected, operation denied</response>
        /// <response code="401">Unauthorized request</response>
        [Route("/api/v1/tariffWagonTypeItems/patch")]
        [HttpPatch("{id}")]
        ...
        [Produces(MediaTypeNames.Application.Json)]
        [Consumes(MediaTypeNames.Application.Json)]
        public override async Task<IActionResult> PatchAsync(long id, [FromBody] JsonPatchDocument<TariffWagonTypeItemDto> patch)
        {
            return await base.PatchAsync(id, patch);
        }

        /// <summary>
        /// Remove tariffWagonTypeItem
        /// </summary>
        /// <remarks>
        /// </remarks>
        /// <response code="200">OK</response>
