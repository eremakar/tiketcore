...
{
    public partial class SeatTypesController
    {
        /// <summary>
        /// Add new seatType
        /// </summary>
        ...
        public override async Task<object> AddAsync([FromBody] SeatTypeDto request)
        {
        ...
        [Produces(MediaTypeNames.Application.Json)]
        [Consumes(MediaTypeNames.Application.Json)]
        public override async Task<object> UpdateAsync([FromBody] SeatTypeDto request)
        {
        ...
        [Produces(MediaTypeNames.Application.Json)]
        [Consumes(MediaTypeNames.Application.Json)]
        public override async Task<IActionResult> PatchAsync(long id, [FromBody] JsonPatchDocument<SeatTypeDto> patch)
        {
